	...
	namespace log {
		namespace global
		{
			...
			static const std::unordered_map<std::string, std::string> type_string =
			{
				...
				{"{0x5}", "0x%05x"}, {"{0x6}", "0x%06x"}, {"{0x7}", "0x%07x"}, {"{0x8}", "0x%08x"}, {"{0x9}", "0x%09llx"}, 
				{"{0x10}", "0x%010llx"}, {"{0x11}", "0x%011llx"}, {"{0x12}", "0x%012llx"}, {"{0x13}", "0x%013llx"}, 
				{"{0x14}", "0x%014llx"}, {"{0x15}", "0x%015llx"}, {"{0x16}", "0x%016llx"},
